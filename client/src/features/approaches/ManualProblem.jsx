                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div className="flex flex-col space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                Paste your problem statement and constraints below for high-level analysis.
                            </p>
                        </div>
                        ...
                        <div className="mt-12 space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-500">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="rounded-2xl border border-border/40 bg-zinc-950 overflow-hidden shadow-2xl relative">
                                    ...
                                    <pre className="p-8 overflow-x-auto text-sm font-mono leading-relaxed text-zinc-300 min-h-[350px] whitespace-pre">
                                        <code>{renderCode(result.solutions[activeTab])}</code>
                                    </pre>
                                </div>
                            </div>
                        </div>
